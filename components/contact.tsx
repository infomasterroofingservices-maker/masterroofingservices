...
export function Contact() {
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl items-start gap-6 px-4 sm:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] sm:gap-x-8 sm:gap-y-0 sm:px-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-x-16">
        <div className="contents sm:col-start-1 sm:row-start-1 sm:flex sm:flex-col sm:gap-8 lg:sticky lg:top-32 lg:gap-10">
          ...
          <div className="order-2 grid grid-cols-2 gap-2 sm:hidden">
            <a
        ...
        <div className="order-3 -mx-4 sm:order-none sm:col-start-2 sm:row-start-1 sm:mx-0">
          <div className="relative overflow-hidden border-t-[3px] border-t-lemon border-b border-b-white/10 bg-dark sm:border sm:border-white/10 sm:border-t-[3px] sm:border-t-lemon">
            ...
            />
            <div className="relative bg-dark/70 px-4 py-6 sm:p-7 lg:p-10">
              <h2 className="text-[1.35rem] font-extrabold tracking-tight text-white sm:text-2xl lg:text-[1.75rem]">
  ...
  return (
    <li>
      {href ? (
        <a
          href={href}
          className="group flex min-h-14 items-center gap-3 py-3 sm:min-h-0 sm:items-start sm:gap-4 sm:py-4"
        >
          {content}
        </a>
      ) : (
