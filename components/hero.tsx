  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-10 pt-[calc(5.5rem+env(safe-area-inset-top))] text-center sm:px-8 sm:pb-20 sm:pt-28 lg:pb-24 lg:pt-32">
        ...
        <p className="animate-fade-up animate-delay-100 text-[11px] font-medium uppercase tracking-[0.22em] text-white/80 sm:text-xs">
          Roofing · Landscaping · Outdoor Living
        </p>
        <h1 className="animate-fade-up animate-delay-200 mx-auto mt-2 max-w-6xl text-[clamp(2.25rem,10.5vw,7.5rem)] font-extrabold leading-[0.92] tracking-tight text-white text-balance">
          Master Roofing
        </h1>
        <p className="animate-fade-up animate-delay-300 mx-auto mt-3 max-w-[20rem] font-display text-[clamp(1rem,4.6vw,3rem)] font-extrabold uppercase leading-snug tracking-wide text-lemon sm:mt-4 sm:max-w-none">
